...
dglke_train --model_name TransE_l2 --batch_size 1024 --log_interval 100 --neg_sample_size 60 \
        ...
        --test -adv -a 1.0 --gpu $CUDA_VISIBLE_DEVICES --max_step 2000 --dataset 'raw_udd_umls' --format 'raw_udd_hrt' \
        --data_path "$MYDATA"/umls --delimiter '\t' --save_path scratch/umls_kge \
