...
IMAGE=/netscratch/pokarats/nvcr.io_nvidia_pytorch_22.03-py3_dglkge.sqsh
NUM_CPUS=8
MEM=32GB
...
dglke_train --model_name TransE_l2 --batch_size 2 --log_interval 10 --neg_sample_size 2 \
        ...
        --test -adv -a 1.0 --gpu $CUDA_VISIBLE_DEVICES --max_step 100 --dataset 'raw_udd_test' --format 'raw_udd_hrt' \
        --data_path "$MYDATA"/raw_udd_2 --delimiter ';' --save_path $OUT_DIR \
